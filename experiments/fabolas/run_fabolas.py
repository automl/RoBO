...
if dataset == "mnist":
    ...
    num_iterations = 80
    output_path = "./experiments/fabolas_journal/results/svm_%s/fabolas_%d" % (dataset, run_id)
    ...
    num_iterations = 50
    output_path = "./experiments/fabolas_journal/results/cnn_%s/fabolas_%d" % (dataset, run_id)
    s_max = f.train.shape[0]
    ...
    num_iterations = 50
    output_path = "./experiments/fabolas_journal/results/res_%s/fabolas_%d" % (dataset, run_id)
    s_max = f.train.shape[0]
