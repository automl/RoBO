...
if dataset == "mnist":
    ...
    num_iterations = 30
    output_path = "./experiments/fabolas_journal/results/svm_%s/mtbo_%d" % (dataset, run_id)
    ...
    num_iterations = 30
    output_path = "./experiments/fabolas_journal/results/cnn_%s/mtbo_%d" % (dataset, run_id)
elif dataset == "svhn":
    ...
    num_iterations = 15
    output_path = "./experiments/fabolas_journal/results/res_%s/mtbo_%d" % (dataset, run_id)
