...
def lenet_mnist_surrogate(x):
    X = np.load("robo/benchmarks/data_lenet_mnist_surrogate/data.npy")
    y = np.load("robo/benchmarks/data_lenet_mnist_surrogate/targets.npy")
...
def get_lenet_mnist_surrogate_bounds():
    cs = ConfigSpace("robo/benchmarks/data_lenet_mnist_surrogate/param.pcs")
