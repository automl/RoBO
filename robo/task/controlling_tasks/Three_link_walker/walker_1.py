...
class Walker(BaseTask):
    ...
    def objective_function(self, x):
        ...
        '''      
        steps = 10
        q_minus = [np.pi/2-np.pi/8, -2*(np.pi/2-np.pi/8), -(np.pi/6-np.pi/8)]
        ...
        output = mlab.run_func('/home/christina/HIWI/Three_link_walker/simulation/walker_simulation.m', 
                               {'arg1': q_minus, 'arg2': dq_minus, 'arg3': x[0], 'arg4': x[1], 'arg5': x[2], 'arg6': x[3], 'arg7': steps})
